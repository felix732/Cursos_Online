...
$sql_cursos = "SELECT i.id_inscripcion, p.id_plani, c.nombre_curso, p.fecha_inicio, p.fecha_cierre, p.statuss 
               FROM inscritos i
               JOIN planificacion p ON i.id_planificacion = p.id_plani
               JOIN curso c ON p.curso = c.id_curso 
               WHERE i.id_persona = '$usuario_id'";
...
<head>
    ...
    <title>Perfil de Estudiante | Felix DEV</title>
...
<body>
    <header class="header">
        <a href="./a01_vista.php" class="logo">
            ...
            <div class="logo-text">FELIX <span>DEV <-</span></div>
        </a>
    </header>
    ...
    <div class="profile-container">
        ...
        <div class="profile-header">
            ...
            <div class="profile-info">
                ...
                <span class="badge-student"><i class="fas fa-user-graduate"></i> ESTUDIANTE</span>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <!-- Columna derecha - Cursos inscritos -->
            <div class="col-md-6">
                <div class="profile-card">
                    <h3><i class="fas fa-book-open"></i> Mis Cursos Inscritos</h3>
                        ...
                        <?php while($curso = $result_cursos->fetch_assoc()): ?>
                            <div class="course-card">
                                ...
                                <div class="mt-2 d-flex justify-content-between align-items-center">
                                    <a href="./a01_vista.php" class="btn btn-sm btn-primary">
                                        <i class="fas fa-eye"></i> Ver curso
                                    </a>
                                    <button class="btn-leave-course" 
                                            onclick="confirmLeaveCourse(<?php echo $curso['id_inscripcion']; ?>)">
                                        <i class="fas fa-sign-out-alt"></i> Salir del curso
                                    </button>
                                </div>
                            </div>
                        <?php endwhile; ?>
    ...
    <script>
        ...
        // Confirmar salida del curso
        function confirmLeaveCourse(idInscripcion) {
            Swal.fire({
                title: '¿Estás seguro?',
                ...
                if (result.isConfirmed) {
                    window.location.href = `borrar_curso.php?id=${idInscripcion}`;
                }
            })
        }

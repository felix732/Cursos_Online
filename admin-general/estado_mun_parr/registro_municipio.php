...
<head>
    ...
    <style>
        ...
        .tabla-municipios tbody tr {
            transition: var(--transicion);
        }

        .tabla-municipios tbody tr:hover {
...
<body>
    <header class="header">
        ...
        <nav>
            <ul class="nav-links">
                ...
                <li><a href="./registro_estado.php"><i class="fas fa-flag"></i> Estados</a></li> 
                <li><a href="registro_parroquias.php"><i class="fas fa-church"></i> Parroquias</a></li>
    ...
    <div class="contenedor-principal">
        <h1 class="titulo-principal"><i class="fas fa-city"></i> Registrar Municipio</h1>
        ...
        <div class="tarjeta-tabla">
            <div class="table-responsive">
                <table class="table tabla-municipios table-hover" id="dataTable">
                    <thead>
                        <tr>
                            <th>ID</th>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <span class="badge-estado"><?php echo $estado_nombre; ?></span>
                                </td>
                                <td>
                                    <div class="acciones">
                                        <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#editar<?php echo $fila['id_municipio']; ?>">
                                            <i class="fas fa-edit"></i> Editar
                                        </button>
                                        <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#delete<?php echo $fila['id_municipio']; ?>">
